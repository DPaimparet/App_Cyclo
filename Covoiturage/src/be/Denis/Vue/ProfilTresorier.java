...
public class ProfilTresorier extends JPanel {
	 ...
	 * Create the panel.
	 */
	public ProfilTresorier(Tresorier tresorier) {
		String sexSelected = tresorier.getSex();
		...
		fieldName = new JTextField(tresorier.getNom());
		...
		textFieldPrenom = new JTextField(tresorier.getPrenom());
		...
		textFieldMail = new JTextField(tresorier.getEmail());
		...
		textFieldLogin = new JTextField(tresorier.getLogin());
		...
		textFieldPwd = new JTextField(tresorier.getPassword());
		...
		textAreaAdress = new JTextArea(tresorier.getAdresse());
		...
		dateAnniversaire = new JDateChooser(tresorier.getDateNaissance());
		...
		btnModifier.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				tresorier.setNom(fieldName.getText());
				tresorier.setPrenom(textFieldPrenom.getText());
				tresorier.setPassword(textFieldPwd.getText());
				tresorier.setDateNaissance(dateAnniversaire.getDate());
				tresorier.setAdresse(textAreaAdress.getText());
				...
				if (tresorier.getNom().equals("") || tresorier.getPrenom().equals("") || tresorier.getLogin().equals("")
						|| tresorier.getPassword().equals("") || tresorier.getDateNaissance() == null || tresorier.getAdresse().equals("")) {
					lblError.setText("Tous les champs ne sont pas remplis");
					error = true;
				}

				if (!error) {
					tresorier.updateInfo();
