...
public class CompteDeplacement extends JPanel {
	 ...
	 * Create the panel.
	 */
	public CompteDeplacement(Tresorier tresorier, DashBoard bureau) {
		...
		JLabel lblGestionDesTransactions = new JLabel("Gestion des d\u00E9placement");
	...
	public Object[][] dataJtable(Tresorier tresorier) {
		...
		for (Transaction t : tresorier.getFraisDeplacement()) {
			if(!t.isPayer()) {
				membre = new Membre().getMembre(t.getIdPersonne());
