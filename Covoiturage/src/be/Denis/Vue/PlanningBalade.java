				...
				if(balade == null) {
						...
						public void actionPerformed(ActionEvent e) {
							...
							btnReserver.addActionListener(new ActionListener() {
								public void actionPerformed(ActionEvent arg0) {
									...
									if(!textFieldNbrPersonne.getText().matches(pattern) || !textFieldNbrVelo.getText().matches(pattern) ) {
										error = true;
										lblError.setText("Entrez un nombre correcte dans les champs");
									}
									if(!error) {
										boolean reservation = membre.reserverBalade(balade, Integer.parseInt(textFieldNbrPersonne.getText()), Integer.parseInt(textFieldNbrVelo.getText()));
										if(reservation) {
					...
					proposer.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent e) {
							...
							JLabel lblTitreProposition = new JLabel("Proposition de places");
							...
							btnProposer.setBounds(200, 400, 176, 40);
