...
public class ProfilResponsable extends JPanel {
	 ...
	 * Create the panel.
	 */
	public ProfilResponsable(Responsable responsable) {
		String sexSelected = responsable.getSex();
		...
		fieldName = new JTextField(responsable.getNom());
		...
		textFieldPrenom = new JTextField(responsable.getPrenom());
		...
		textFieldMail = new JTextField(responsable.getEmail());
		...
		textFieldLogin = new JTextField(responsable.getLogin());
		...
		textFieldPwd = new JTextField(responsable.getPassword());
		...
		textAreaAdress = new JTextArea(responsable.getAdresse());
		...
		dateAnniversaire = new JDateChooser(responsable.getDateNaissance());
		...
		btnModifier.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
					responsable.setNom(fieldName.getText());
					responsable.setPrenom(textFieldPrenom.getText());
					responsable.setPassword(textFieldPwd.getText());
					responsable.setDateNaissance(dateAnniversaire.getDate());
					responsable.setAdresse(textAreaAdress.getText());
					...
					if(rdbtnHomme.isSelected()) {
						responsable.setSex("H");
					}
					else {
						responsable.setSex("F");
					}
					
					if(responsable.getNom().equals("") || responsable.getPrenom().equals("") || responsable.getLogin().equals("") || responsable.getPassword().equals("") || responsable.getDateNaissance() == null || responsable.getAdresse().equals("") ){
